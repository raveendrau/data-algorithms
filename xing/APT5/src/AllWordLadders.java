...
//	
	...
	public static void main(String[] args){
		AllWordLadders a = new AllWordLadders();
		String[] words = {"rain", "ruin", "gain", "grin", "grit", "main", "pain", "pair", "pail", "mail"};
		System.out.print(Arrays.toString(a.solve(words,  "sail", "ruip")));
//	String[] words = {"toast", "roast", "boast" };
//	System.out.print(Arrays.toString(a.solve(words,  "coast","shore")));
		System.out.println(a.changeable("grit", "ruip"));
	//
//		String[] words = {"dire", "hire", "wire", "mire", "here", "were", "mere", "care", "tart", "dart", "dare", "dirt" };
//		System.out.print(Arrays.toString(a.solve(words, "cart", "pere")));
//	String[] words = {"big", "bag", "beg", "bog", "lag", "leg", "log", "lug", "hug", "tug", "mug", "hut", "tut", "mut", "hum", "tum", "mum", "ham", "tam", "mam", "cam" };
//	System.out.print(Arrays.toString(a.solve(words, "bit","cat")));
